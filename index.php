...
<?php
	...
	if(isset($_POST["register"])) {
		...
		if(isset($_POST["patient"])){
			$role = 'patient';
			message($funPatient->recoverCode($con,$password,$id));
        ...
        <body>
            <div class="main" id="home">
                ...
                <div class="header_of_web">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form">
                                            <form action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="POST">
                                                ...
                                                <input type="number" name="pNumber" class="form-control patient"  placeholder="Patient/Stuff Code" autofocus>
                                                <br>
												...
												<a href="#" data-toggle="modal" data-target="#recoverCode">forgot user code?</a>
                                                    <p>Check our social network</p>
                                                    <button href="https://www.facebook.com/tlckramers/" class="btn btn-facebook" type="submit"><i class="fa fa-facebook"></i> Facebook</button>
                                                    <button href="https://twitter.com/LloydsPharmacy" class="btn btn-twitter" type="submit"><i class="fa fa-twitter"></i> Twitter</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
					...
					<!-- -->
					 <div class="modal fade" id="recoverCode" role="dialog">
                        <div class="modal-dialog login-form">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h4 class="modal-title">Recover user Code</h4>
                                </div>
                                <div class="modal-body">
                                    <div class="col-md-12">
                                        <div class="form">
                                            <form action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="POST">
                                                ...
                                                <input type="text" name="id" class="form-control patient"  placeholder="ID" autofocus>
                                                <br>
												<label>Password:</label>
                                                <input type="password" name="password" class="form-control"   placeholder="Password">
                                                <button class="btn btn-login btn-block" name="recover" type="submit"><i class="fa fa-lock"></i> RECOVER</button>
                                                <hr>
            ...
            <div class="about" id="about">
                <div class="container">
                    <h2 class="doctor_heade_tittle_agile">Welcome to NTULI Pharmacy </h2>
                    <p class="sub_t_agileits">We care about your health</p>
                    <p class="ab">Make online bookings,and buy your doctor's prescribed medecine at more than 74 phamarcies using only your patient Code</p>
